...
export const AdminAgentsThirdParty: React.FC = () => {
  ...
  const filteredAgents = useMemo(() => {
    return agents.filter(a => {
      const isThirdParty = a.agentType === 'Third Party';
      const matchesSearch = a.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
        a.email.toLowerCase().includes(searchTerm.toLowerCase()) ||
        a.id.toLowerCase().includes(searchTerm.toLowerCase());
      return isThirdParty && matchesSearch;
    });
  }, [agents, searchTerm]);
  ...
  return (
    <div className="space-y-6 font-sans">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-[20px] font-bold text-text-primary font-display">Third Party Agents</h2>
          <p className="text-xs text-text-secondary">View, edit, and toggle active status for external partner agents</p>
        </div>
        <button
        ...
        >
          ...
          <span>Add Third Party Agent</span>
        </button>
      </div>
      ...
      <div className="bg-white rounded-xl border border-border-light shadow-sm overflow-hidden">
        {loadingAgents ? <PageLoader /> : filteredAgents.length === 0 ? (
          <div className="p-8 text-center flex flex-col items-center">
            ...
            <p className="text-xs font-semibold text-text-primary">No Third Party agents found</p>
          </div>
        ) : (
...
export default AdminAgentsThirdParty;
