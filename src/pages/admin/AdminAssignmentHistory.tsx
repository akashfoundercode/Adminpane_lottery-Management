...
export const AdminAssignmentHistory: React.FC = () => {
  const { assignmentHistory, assignmentHistoryPagination, games, agents, fetchAssignmentHistory } = useAdmin();
      ...
      <div className="bg-white rounded-xl border border-border-light shadow-sm overflow-hidden">
        ...
        {assignmentHistoryPagination.hasMore && (
          <div className="px-4 py-3 border-t border-border-light bg-slate-50/50 flex items-center justify-between">
            ...
            <button onClick={() => fetchAssignmentHistory(10, assignmentHistoryPagination.currentPage * 10, true)} className="px-4 py-2 border border-border-light bg-white rounded-lg text-[10px] font-semibold text-text-primary hover:bg-slate-50">View More</button>
          </div>
        )}
      </div>
    </div>
