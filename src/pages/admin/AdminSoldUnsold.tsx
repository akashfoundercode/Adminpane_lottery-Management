        ...
        <>
            <div className="space-y-6 font-sans">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 bg-white p-4 rounded-xl border border-border-light shadow-sm">
                    ...
                    <div className="relative">
                        <select value={gameFilter} onChange={event => setGameFilter(event.target.value)} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs appearance-none text-text-primary">
                    ...
                    <div className="relative">
                        <select value={agentFilter} onChange={event => setAgentFilter(event.target.value)} className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-xs appearance-none text-text-primary">
