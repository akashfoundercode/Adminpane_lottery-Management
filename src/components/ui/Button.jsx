...
const Button = ({
  ...
  const baseStyles = 'relative inline-flex items-center justify-center font-display font-semibold tracking-wide rounded-full px-8 py-3.5 text-sm transition-all duration-300 focus:outline-none cursor-pointer overflow-hidden z-10';
